    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          ...
          children: [
            // Base Image Layer
            _buildImage(widget.destination.imagePath),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          '${widget.destination.duration} • ${widget.destination.price}'.replaceAll(RegExp(r'\s*(per person|/ person)', caseSensitive: false), '\nper person'),
                          style: GoogleFonts.poppins(
                            color: Colors.white,
                            fontSize: 11,
